...
from dem_hyperelasticity.DEM_viscoelasticity.config import *
...
def setup_domain():
    ...
    bcl_u_pts_idx_3 = np.where(dom[:, 1] == Height)
    bcl_u_pts_3 = dom[bcl_u_pts_idx_3, :][0]  
    bcl_u_3 = np.ones(np.shape(bcl_u_pts_3)) * [0,Height*epsr]
    ...
    bcr_t = np.ones(np.shape(bcr_t_pts)) * [0, 100]
