...
class EnergyModel:
    ...
    def NeoHookean3D(self, u, x):
        ...
        energy = epsxx*sigmaxx+epsxy*sigmaxy+epsxz*sigmaxz+epsyx*sigmayx+epsyy*sigmayy+epsyz*sigmayz+epszx*sigmazx+epszy*sigmazy+epszz*sigmazz
    ...
    def NeoHookean2D(self, u, x):
        ...
        energy = epsxx*sigmaxx+epsxy*sigmaxy+epsyx*sigmayx+epsyy*sigmayy
