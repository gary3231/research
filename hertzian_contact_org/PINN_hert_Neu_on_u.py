...
import os,sys
sys.path.append("")
from dem_hyperelasticity.hertzian_contact_pin import define_structure_Neu as des
from dem_hyperelasticity.MultiLayerNet import *
from dem_hyperelasticity.hertzian_contact_pin import PINNmodel_neu as md
from dem_hyperelasticity import Utility as util
from dem_hyperelasticity.hertzian_contact_pin import config as cf
from dem_hyperelasticity.IntegrationLoss import *
from dem_hyperelasticity.hertzian_contact_pin.PINNmodel_neu import *
from dem_hyperelasticity.hertzian_contact_pin import pin_alg as pin
import numpy as np
import time
import torch
        ...
        for t in range(iteration):
            ...
            def closure():
                ...
                print('Iter: %d Loss: %.6e strong_form: %.6e dir_bc: %.6e neu_bc: %.6e  Time: %.3e'
                      % (t + 1, loss.item(), strong.item(),lkkt.item(),lkkt.item(), time.time() - it_time))
...
if __name__ == '__main__':
    ...
    # cf.filename_out = "dem_hyperelasticity/hertzian_contact_square/output/hert_100itr"
    cf.filename_out = "dem_hyperelasticity/hertzian_contact_square/output/hert_100itr_onlyu_fb_soft"
    ...
    util.write_vtk_v2(cf.filename_out, x, y, z, U, P)
    surUx, surUy, surUz = U
