import dem_hyperelasticity.winkler_model_pinn.Integration as Integration
import dem_hyperelasticity.winkler_model_pinn.config as cf 
from dem_hyperelasticity.winkler_model_pinn.Integration import *
from dem_hyperelasticity.winkler_model_pinn import define_structure_sub as des_s
from dem_hyperelasticity.winkler_model_pinn.MultiLayerNet_sub import *
import torch
import numpy as np
import pandas as pd
...
def deform_sub(p, xv, xs, dxdydz, shape, IntType, dim):
    ...
    us[x_load,:] =  loads*(1-cf.nus**2)/torch.pi/cf.Es#*2/(torch.pi**2)*cf.Ec/cf.Es
